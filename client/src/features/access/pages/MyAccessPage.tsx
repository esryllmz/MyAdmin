...
const ACCESS_BY_ROLE: Record<string, AccessCapability> = {
  ...
  Editor: {
    scope: "Viewer user operations, Teams, and operational reporting",
    you_can: [
      "View and manage Viewer accounts",
      "Create Viewer accounts",
      "Activate/deactivate Viewer accounts",
      "Create and update Teams",
      "Manage Viewer Team memberships",
      "Review operational activity",
      "Export approved operational reports",
      "Manage your own account preferences",
    ],
    restricted: [
      "Delete users",
      "Manage Admin or Editor accounts",
      "Assign Editor or Admin roles",
