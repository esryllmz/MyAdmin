    ...
    <header className="bg-surface/80 dark:bg-dark-surface/80 backdrop-blur-md sticky top-0 w-full z-30 border-b border-outline-variant/10 dark:border-dark-outline-variant/10 flex items-center justify-between px-8 h-16 transition-colors">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative" ref={menuRef}>
          ...
          {/* Dropdown Menu */}
          {isMenuOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-surface-container-lowest dark:bg-dark-surface-container-low rounded-xl shadow-xl border border-outline-variant/10 dark:border-dark-outline-variant/10 py-2 animate-in fade-in zoom-in duration-150">
              <div className="px-4 py-2 border-b border-outline-variant/10 dark:border-dark-outline-variant/10 mb-2">
              ...
              <button className="w-full flex items-center gap-3 px-4 py-2 text-sm text-on-surface dark:text-dark-on-surface hover:bg-surface-container-low dark:hover:bg-dark-surface-container-high transition-colors">
              ...
              <button
                onClick={logout}
                className="w-full flex items-center gap-3 px-4 py-2 text-sm text-error hover:bg-error/5 dark:hover:bg-error/10 transition-colors"
              >
